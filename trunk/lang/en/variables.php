...
$classnew_head  ="New Ads"; // Added in V2.0.0
...
$memf_timezone  ="TimeZone"; // Added in V2.0.0
$memf_dateformat="DateFormat"; // Added in V2.0.0
...
$admy_move  ="Move this Ad Entry"; // Added in V2.0.0
$admy_member    ="Member: ";
...
$admymove_head  ="Move Ad"; // Added in V2.0.0
$admymove_msg   ="Please select the correct sub-category !"; // Added in V2.0.0
$admymove_submit="Move Ad"; // Added in V2.0.0
$admymove_done  ="Your Ad is now moved !"; // Added in V2.0.0
...
$require    ="(value required)"; // Added in V2.0.0
