...
$mail_new       ="Neue Nachricht"; // Added in V2.0.2
...
$classnew_head  ="Neue Inserate"; // Added in V2.0.0
...
$memf_timezone  ="ZeitZone"; // Added in V2.0.0
$memf_dateformat="DatumsFormat"; // Added in V2.0.0
...
$memb_detpic    ="PIC"; // Added in V2.0.0
...
$admy_edit	="Anzeige ändern";
$admy_delete	="Anzeige löschen";
$admy_move      ="Anzeige verschieben"; // Added in V2.0.0
$admy_member	="Mitglied: ";

$admydel_head	="Anzeige löschen";
$admydel_msg	="Willst Du dieses Inserat wirklich löschen ?";
$admydel_submit ="Löschen";
$admydel_done	="Dein Inserat ist nun gelöscht !";

$admymove_head  ="Anzeige verschieben"; // Added in V2.0.0
$admymove_msg   ="Bitte wähle die neue SubKategorie !"; // Added in V2.0.0
$admymove_submit="Verschieben"; // Added in V2.0.0
$admymove_done  ="Die Anzeige ist nun verschoben !"; // Added in V2.0.0
...
$require	="(zwingend erforderlich)"; // Added in V2.0.0
