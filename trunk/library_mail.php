<?php
if(!strpos($_SERVER['PHP_SELF'],'library_mail.php') === false)
{
...
class phpmailer
{
     ...
     * on http://bugs.php.net. The *NIX #$Id$of PHP
    ...
    */
    ...
    function create_header() {
        ...
        $header[] = sprintf("X-Mailer: phpmailer [#$Id$%s]%s", $this->Version, $this->LE);
        if($this->Sender == "")
