...
if (!$_SESSION[suserid] && !$guestbookfree) {
...
echo" <p><div class=\"footer\">phpBook Ver. $book_#$Id$&copy 2001-".date("Y")." by <a href=\"http://www.smartisoft.com\" target=\"_blank\">SmartISoft</a></div>\n";
#####################################################################################################################
